...
func NewLottery(UserInfo models.LoAgentUser) *Lottery {
	aServer := &Lottery{}
...
func (receiver *Lottery) GetOriginalData(v map[string]interface{}) (map[string]interface{}, error) {
	return nil, nil
}
func (receiver *Lottery) ToMapNumData(v interface{}) map[string]models.LoAgentBetNumData {
	return nil
}
...
func (receiver *Lottery) GetUserInfo() models.LoAgentUser {
